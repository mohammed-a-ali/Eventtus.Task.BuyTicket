$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("file:src/test/java/features/BuyTicket.feature");
formatter.feature({
...
formatter.match({
  "location": "BuyTicket.iClickSubmitButton()"
});
formatter.result({
  "status": "passed"
});
...
formatter.result({
  "error_message": "org.openqa.selenium.NoSuchElementException: no such element: Unable to locate element: {\"method\":\"link text\",\"selector\":\"Create new account\"}\n  (Session info: chrome\u003d78.0.3904.70)\nFor documentation on this error, please visit: https://www.seleniumhq.org/exceptions/no_such_element.html\nBuild info: version: \u00273.141.59\u0027, revision: \u0027e82be7d358\u0027, time: \u00272018-11-14T08:17:03\u0027\nSystem info: host: \u0027DESKTOP-TO67BV2\u0027, ip: \u0027192.168.1.7\u0027, os.name: \u0027Windows 10\u0027, os.arch: \u0027amd64\u0027, os.version: \u002710.0\u0027, java.version: \u002712.0.2\u0027\nDriver info: org.openqa.selenium.chrome.ChromeDriver\nCapabilities {acceptInsecureCerts: false, browserName: chrome, browserVersion: 78.0.3904.70, chrome: {chromedriverVersion: 78.0.3904.70 (edb9c9f3de024..., userDataDir: C:\\Users\\kaiba\\AppData\\Loca...}, goog:chromeOptions: {debuggerAddress: localhost:65195}, javascriptEnabled: true, networkConnectionEnabled: false, pageLoadStrategy: normal, platform: XP, platformName: XP, proxy: Proxy(), setWindowRect: true, strictFileInteractability: false, timeouts: {implicit: 0, pageLoad: 300000, script: 30000}, unhandledPromptBehavior: dismiss and notify}\nSession ID: 331b3fab91fe9e375347501012da228d\n*** Element info: {Using\u003dlink text, value\u003dCreate new account}\r\n\tat java.base/jdk.internal.reflect.NativeConstructorAccessorImpl.newInstance0(Native Method)\r\n\tat java.base/jdk.internal.reflect.NativeConstructorAccessorImpl.newInstance(NativeConstructorAccessorImpl.java:62)\r\n\tat java.base/jdk.internal.reflect.DelegatingConstructorAccessorImpl.newInstance(DelegatingConstructorAccessorImpl.java:45)\r\n\tat java.base/java.lang.reflect.Constructor.newInstanceWithCaller(Constructor.java:500)\r\n\tat java.base/java.lang.reflect.Constructor.newInstance(Constructor.java:481)\r\n\tat org.openqa.selenium.remote.http.W3CHttpResponseCodec.createException(W3CHttpResponseCodec.java:187)\r\n\tat org.openqa.selenium.remote.http.W3CHttpResponseCodec.decode(W3CHttpResponseCodec.java:122)\r\n\tat org.openqa.selenium.remote.http.W3CHttpResponseCodec.decode(W3CHttpResponseCodec.java:49)\r\n\tat org.openqa.selenium.remote.HttpCommandExecutor.execute(HttpCommandExecutor.java:158)\r\n\tat org.openqa.selenium.remote.service.DriverCommandExecutor.execute(DriverCommandExecutor.java:83)\r\n\tat org.openqa.selenium.remote.RemoteWebDriver.execute(RemoteWebDriver.java:552)\r\n\tat org.openqa.selenium.remote.RemoteWebDriver.findElement(RemoteWebDriver.java:323)\r\n\tat org.openqa.selenium.remote.RemoteWebDriver.findElementByLinkText(RemoteWebDriver.java:380)\r\n\tat org.openqa.selenium.By$ByLinkText.findElement(By.java:220)\r\n\tat org.openqa.selenium.remote.RemoteWebDriver.findElement(RemoteWebDriver.java:315)\r\n\tat org.openqa.selenium.support.pagefactory.DefaultElementLocator.findElement(DefaultElementLocator.java:69)\r\n\tat org.openqa.selenium.support.pagefactory.internal.LocatingElementHandler.invoke(LocatingElementHandler.java:38)\r\n\tat com.sun.proxy.$Proxy24.click(Unknown Source)\r\n\tat pages.PageBase.clickButton(PageBase.java:20)\r\n\tat pages.HomePage.openRegistrationPage(HomePage.java:27)\r\n\tat steps.UserRegistration.i_click_on_register_link(UserRegistration.java:32)\r\n\tat ✽.I click on register link(file:src/test/java/features/BuyTicket.feature:19)\r\n",
  "status": "failed"
});
formatter.step({
  "name": "I entered the user data",
...
formatter.step({
  "name": "I open FIFA2022 event",
  "keyword": "When "
});
formatter.match({
  "location": "BuyTicket.iOpenFIFAEvent()"
});
formatter.result({
  "status": "skipped"
});
...
formatter.step({
  "name": "I click Pay button",
  "keyword": "And "
});
formatter.match({
  "location": "BuyTicket.iClickPayButton()"
});
formatter.result({
  "status": "skipped"
});
formatter.step({
  "name": "I select Credit Card",
  "keyword": "And "
});
formatter.match({
  "location": "BuyTicket.iSelectCreditCard()"
});
formatter.result({
  "status": "skipped"
});
formatter.step({
  "name": "I fill Credit Card Data",
  "keyword": "And "
});
formatter.match({
  "location": "BuyTicket.iFillCreditCardData()"
});
formatter.result({
  "status": "skipped"
});
